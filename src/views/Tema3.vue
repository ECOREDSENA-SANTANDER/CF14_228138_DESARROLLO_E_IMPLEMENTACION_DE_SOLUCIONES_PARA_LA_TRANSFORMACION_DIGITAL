  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .bg--piel.br.my-4.he-4-cus.px-4.pt-3
          ...
          .row.justify-content.mb-5(data-aos="zoom-in-left")
            ...
            .d-flex.justify-content-center
              img.itt.mb-lg-0.mb-3.mx-5(src="@/assets/curso/temas/tema3/ppp.svg")
      .mb-4
      p.mb-5 Independientemente del ambiente y herramienta seleccionada (ya sea de uso libre o de pago), la mayoría cuentan con el siguiente esquema visual.
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h3.text-white.mb-1 Programiz Online SQL Editor           
    ...
    .row.justify-content-center.mb-4(data-aos="zoom-in")
          .col-lg-8.mb-3.mb-lg-0
            .bg-49.p-4.my-3
              ...
              p.mb-0.mx-4 #[b Sentencia: Select.]
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-6.order-lg-1(data-aos="fade-right")
        ...
        p.mb-4 En el siguiente ejemplo se tienen las tablas Orders (órdenes) y Customers (clientes), el campo en común en la tabla ordenes que asocia un cliente a través de “customer_id”. A continuación, se desea ver en una sola tabla el id de la orden y el monto (que están en la tabla ‘Orders’), pero también el nombre del cliente (que está en la tabla Customers)
