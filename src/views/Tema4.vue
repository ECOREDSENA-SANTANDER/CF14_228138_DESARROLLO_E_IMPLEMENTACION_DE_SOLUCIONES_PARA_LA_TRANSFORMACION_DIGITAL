...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
            ...
            .col-lg-12.col-12
              .bloque-texto-g.col.color-acento-contenido.p-lg-5
                .bloque-texto-g__img.col(
                  :style="{'background-image': `url(${require('@/assets/curso/temas/tema4/img4.png')})`}"
                )
    ...
    p.mb-4 Los cubos de datos, no son precisamente parte del proceso ETL, los cubos es una estructura en la que la bodega de datos o el DWH entrega datos para consumirlos a través de visualización en tablas o gráficos multidimensionales.
    
    .row.justify-content-center.align-items-center(data-aos="fade-left")
      .col-lg-2.col-8
        img.po(alt="" src="@/assets/curso/temas/tema4/img8.svg")
      .col-lg-8.col-12.p-0
    ...
    .row(data-aos="zoom-in")
      ...
      p.mb-5 No basta con tener registrados estos cinco mínimos componentes de las tareas más relevantes para que los datos muestran una radiografía clara sobre cada proceso. Además, es importante tener claridad sobre la calidad de los datos para que se puedan integrar y tener plena confianza. 
    
    
    .tarjeta--container.parr.row
