...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-lg-12.col-12.px-lg-5.px-0.p-2
        .row.justify-content-center.mb-0(data-aos="fade-down")   
          .row.align-items-center.justify-content-center.mb-0(data-aos="zoom-in-left")
            .col-lg-3.my-4
              img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/temas/tema2/img2.png', alt='')
            .col-lg-9.my-2
    ...
    .row.justify-content-center.align-items-center(data-aos="zoom-in-left")
      .col-lg-10
        .fondo21.p-3.mb-4(data-aos="zoom-in")
          .row.justify-content-center.align-items-center
            .col-3.col-sm-2.col-lg-2.mx-5
              img.my-3.img-a.img-t(src="@/assets/curso/temas/tema2/open.svg")
    ...
    p.mb-2 Una de las maneras para garantizar que los datos tengan integridad y unicidad entre varios sistemas transaccionales y el sistema analítico mismo es el empleo de datos maestros #[em #[b (Master Data Management).]]

    .row.justify-content-center.align-items-center.mb-0(data-aos="fade-left")
      .col-lg-4.col-8
        img.mb-lg-0.mb-3(src="@/assets/curso/temas/tema2/img6.png" alt="")
      .col-lg-8.col-12
        p.mb-3.my-3 #[b Los datos maestros] son una arquitectura para administrar, centralizar, organizar, clasificar, localizar, sincronizar y enriquecer los datos según las reglas de negocio. La gestión de datos maestros (MDM, por sus siglas en inglés) se resume en un repositorio central que garantiza una única visión autorizada de la información y optimiza costos e ineficiencias causadas por los almacenamientos de datos dispersos, apoya reportes de negocio mediante la ubicación exacta, vinculación y propiedades de entidades y de la información a través de productos, clientes, tiendas, ciudades, empleados, proveedores, activos digitales y más. 
        .cajon.color-secun.p-4.mb-4
          p.mb-2 Por ello, se convierte en habilitador clave para proporcionar una vista única y confiable de la información empresarial crítica. Las fuentes de datos confiables ayudan a reducir los costos de integración de aplicaciones, mejoran la experiencia del cliente y generan información analítica accionable (#[em Stibo System] MDM, 2019).  
          
    .row.fondoos.align-items-center.py-md-5
